import { DayShifts as DaysWithShifts, PositionOnPriorities, Shift, ShiftDetail, Soldier, RolesWithCandidates, PositionsWithCandidatesByRoles } from './types.js';
import { isTimeBefore } from './utils.js';
import fs, { readFileSync } from 'fs'


export const addCandidatesToShifts = (soldiers: Soldier[], positions: PositionOnPriorities[], daysWithShifts: DaysWithShifts[]) => {
